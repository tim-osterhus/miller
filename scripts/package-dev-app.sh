...
avatar_package_revision="dac4d0ab432a9c158dca40985b28335bdfc70e2b"
...
if [[ "$package_mode" == "release" ]]; then
  ...
  cp "$repo_root/NOTICE" "$legal_root/NOTICE"
  {
    ...
    printf 'Miller Avatar v0.1.0-alpha.3 is linked from https://github.com/tim-osterhus/miller-avatar.git at commit dac4d0ab432a9c158dca40985b28335bdfc70e2b under Apache-2.0. Its host resource bundle contains only Web/app.js, Web/bundle-manifest.json, Web/bundle-metafile.json, Web/index.html, and Web/styles.css; no VRM or VRMA character or motion assets are shipped.\n\n'

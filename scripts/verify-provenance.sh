...
grep -Fq 'dac4d0ab432a9c158dca40985b28335bdfc70e2b' \
  "$repo_root/Package.resolved"
grep -Fq '## Miller Avatar v0.1.0-alpha.3' "$repo_root/PROVENANCE.md"
grep -Fq '## Miller Avatar v0.1.0-alpha.3' "$repo_root/THIRD_PARTY_NOTICES.md"
...
for required in \
  ...
  "365201299955e46b8731b0fa7e8a9badfcd14e32619b289eb9aa68ae022b9892" \
  "Mapbox Earcut 3.0.1" \
...
const avatarPackageVersion = "0.1.0-alpha.3";

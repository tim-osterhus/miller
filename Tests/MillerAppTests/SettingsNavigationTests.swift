...
struct SettingsNavigationTests {
    ...
    func avatarSectionMapsToDedicatedAccessibleSource() throws {
        ...
        #expect(source.contains("Enable Lip Sync"))
        #expect(source.contains("Uses five-vowel lip sync"))
        #expect(source.contains("Import quality"))
        #expect(source.contains("High Quality"))
        #expect(source.contains("model.setImportQualityMode(value)"))
        #expect(source.contains("substantial memory, GPU memory, load time"))
        #expect(source.contains("finite safety ceilings"))
        #expect(source.contains("|| model.isImportQualityPersistencePending"))
